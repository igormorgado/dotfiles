...
def get_objective_urls_list(filename):
    ...
    #print filename
    #print CHM2PDF_WORK_DIR
    if os.path.exists(CHM2PDF_WORK_DIR) == False :
        #print 'start'
...
def convert_to_pdf(cfile, filename, outputfilename, options):
    ...
    #
    print 'Conversion proccess entered'
    global CHM2PDF_WORK_DIR
    global CHM2PDF_ORIG_DIR
    ...
    if options['dontextract'] == '':
        ...
        print 'There are', len(htmlout_filenames), 'files in htmlout_filenames'
